...
INSERT INTO "new_users" ("id", "name", "package_id", "password", "payment_method", "phone", "reseller_id", "role", "username") SELECT "id", "name", "package_id", "password", "payment_method", "phone", "reseller_id", "role", "username" FROM "users";
DROP TABLE "users";
